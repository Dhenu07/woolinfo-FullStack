                ...
                <div className="coursecards">
                    <div className="innercard">
                        ...
                        <div className="innerconten">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="55" height="45" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 15 15"></polyline></svg>
                            <h4>15 Minutes</h4><br/>
