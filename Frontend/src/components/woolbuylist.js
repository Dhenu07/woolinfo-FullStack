...
// import io from '../uploads/65c0eff95827cef8afc43d1d_peakpx (6).jpg';
const WoolBuyList=({wools,available,cost,length,Vm,Micorns,Country,Address,Email,Phone,farmname,image})=>{
